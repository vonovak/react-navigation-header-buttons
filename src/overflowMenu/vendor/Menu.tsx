...
import type { NativeEventSubscription } from 'react-native/types';
...
export class Menu extends React.Component<Props, State> {
  ...
  private backPressListener: NativeEventSubscription | undefined;
  private dimensionChangeListener: EmitterSubscription | undefined;
  ...
  attachListeners = () => {
    ...
    this.dimensionChangeListener = Dimensions.addEventListener(
      'change',
      this.handleDismiss
    );
